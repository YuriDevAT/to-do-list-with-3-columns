  ...
  return (
    <div className="bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 min-w-screen min-h-screen text-center box-border">
      <header className="py-12 text-gray-100 font-sans">
        <h1 className="text-6xl sm:text-8xl font-react-font text-blue-800 tracking-tighter">To Do List</h1>  
        <h2 className="text-sm sm:text-lg mt-3 font-subheading">using React &amp; TailwindCSS</h2>        
      </header>
      <Form
      input={input}
      setInput={setInput}
