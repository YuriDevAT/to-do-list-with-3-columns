...
const DeleteModal = ({ showModal, setShowModal, deleteTask, task }) => {
      ...
      {showModal ? (
        <div className="bg-white rounded-lg w-1/2 text-center border ${showHideClassName}">
          ...
          <div className="pb-4 flex justify-around">
            <button onClick={closeHandler} className="w-1/3 px-4 py-3 text-center bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-black font-bold rounded-lg text-sm">Cancel</button>
