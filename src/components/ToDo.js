...
const ToDo = ({ text, todo, todos, setTodos }) => {    
    ...
    return (
        <div >
            ...
            <button onClick={completeHandler} aria-label="mark item as done" className="bg-blue-500 hover:bg-blue-700 jflex-initial px-4"><i className="fas fa-check"></i></button>
